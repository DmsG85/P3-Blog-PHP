...
class Post extends Database { 
    ...
    {
        $db = new Database();
        $return = $db->select(array($this->postid, $this->postname, $this->postdesc, $this->postpicture, $this->postdate,$this->chapo, $this->postupdate ), array($this->poststable), array($this->poststatut=>$type));
