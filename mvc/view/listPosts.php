                ...
                <div class="post-text d-flex h-100 flex-column justify-content-between  px-2 px-md-4 py-4">
                        <div class="d-flex flex-md-row flex-column">
                            ...
                            <div class="post-list-picture col-md-4 col-12"> 
                                <img src="public/img/business-woman"<?php echo $value["picture"]; ?> class="img-thumbnail" alt="">    
                            </div>
                            ...
                            <div class="post-chapo col-md-8 col-12 text-center text-lg-left pl-md-4 pt-2 px-0">
                                ...
                                <a class="btn btn-primary " href="postView&idPost">Lire la suite...</a>
                        ...
                        <div class="post-author d-flex mt-4 align-items-center">
                            ...
                            <div class="text-white-50 posts-informations">
                                <p class="mb-0">Posté par <?php echo $value["User_idUser"]; ?></p>
        ...
        <div class="blog-right-col col-lg-3 col-sm-10 pl-0 mx-auto">
            ...
            <div class="blog-right-col-div recent-posts mb-5">
                ...
                <div class="recent-post">
                        ...
                        <p>De plus en plus de cadre, de tout âge, changent d... - <a href="index.php?action=postView;id=18">En savoir plus</a></p>
                                                <h5>La taille des pierres<em> (posté le 22-03-2020)</em></h5>
                        <p>Tailler des pierres c&#039;est tout un métier !... - <a href="index.php?action=postView;id=17">En savoir plus</a></p>
                                                <h5>Praesent ut ligula<em> (posté le 22-03-2020)</em></h5>
                        <p>Etiam vitae tortor. Curabitur blandit mollis lacus... - <a href="index.php?action=postView;id=16">En savoir plus</a></p>
