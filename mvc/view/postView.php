...
<header class="post-view-head pb-5">
    <div class="container d-flex h-100 align-items-end">
        <div class="mx-auto text-center">
            <h1 class="mx-auto my-0 text-uppercase">Cette génération qui change de vie </h1>
            <div class="d-flex mt-4 align-items-center">
                <div class="avatar mr-3" style="background-image: url('public/uploads/1584900396.7858_omnz2dlu9q.jpg');">
                </div>
    ...
    <div class="post-section row container-fluid mx-0 px-0">
        ...
        <div class="blog-post col-md-9 mx-auto px-0">
            ...
            <div class="post-content px-4 px-md-5 mb-5">
                ...
                <h2 class="mb-4">Cette génération qui change de vie </h2>
                <hr class="d-none d-lg-block ml-0">

                <p>De plus en plus de cadre, de tout âge, changent de vie pour un retour à la simplicité, et vous ?</p>
            ...
            <div class="post-comments px-4 px-md-5 mb-5" id="comments-section">
                ...
                <a href="index.php?action=connexionView" class="btn btn-primary-custom my-4">Se connecter pour laisser un commentaire</a>
